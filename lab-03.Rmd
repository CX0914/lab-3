...
author: ", User2, User3, User4, User5 and User6 - Team Name"
date: "`r Sys.Date()`"
...
In wide, each subject is a single row with different columns of variables
In long, each subject has MULTIPLE rows with a single column for one variable type
